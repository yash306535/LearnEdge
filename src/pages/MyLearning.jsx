                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                    {inProgress.map(c => {
                      ...
                      return (
                        ...
                        >
                          <img src={c.thumbnail} alt={c.title} style={{ width: 140, height: 90, borderRadius: 'var(--radius-sm)', objectFit: 'cover', flexShrink: 0 }} />
                          <div style={{ flex: 1 }}>
                    ...
                    {completed.map(c => {
                      ...
                      return (
                        <div
                          key={c.id}
                          style={{
                            background: 'white', border: '2px solid var(--success)', borderRadius: 'var(--radius-lg)',
                            padding: '1.5rem', display: 'flex', gap: '1.5rem', alignItems: 'center',
                            cursor: 'pointer', transition: 'all var(--transition)',
                          }}
                          onClick={() => navigate(`/courses/${c.id}`)}
